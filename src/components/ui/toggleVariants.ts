  ...
  "inline-flex items-center justify-center whitespace-nowrap text-base text-foreground font-medium duration-150 ease-out focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-foreground disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        outline:
          "border  border-foreground/20 dark:data-[state=on]:bg-mirage-100 data-[state=on]:bg-mirage-900 data-[state=on]:hover:bg-mirage-800 data-[state=on]:text-mirage-50 dark:data-[state=on]:text-mirage-950 dark:data-[state=on]:hover:bg-mirage-200 w-full data-[state=on]:rounded-[12px] data-[state=on]:active:rounded-[8px] dark:bg-mirage-900 dark:hover:bg-mirage-800 bg-mirage-100 hover:bg-mirage-200",
      },
      size: {
