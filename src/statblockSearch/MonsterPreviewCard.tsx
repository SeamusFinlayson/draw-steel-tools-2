...
export function MonsterPreviewCard({
  ...
  return (
    <div className="flex w-full gap-1 overflow-clip rounded-2xl">
      <button
        className="bg-mirage-100 hover:bg-mirage-200 dark:hover:bg-mirage-800 text-foreground-secondary dark:bg-mirage-900 block grow rounded-r-sm px-4 py-2 text-start text-sm font-normal duration-150"
        onClick={onCardClick}
      >
